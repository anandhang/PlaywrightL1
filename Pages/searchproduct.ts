...
export class ProductPage
{
    ...
    {
        this.page = page
        this.products = this.page.locator("card h-100");
        this.addToCardBtn = this.page.locator("//a[@class='nav-link btn btn-primary']");
    }
    ...
    async addProduct(productName : string)
    {
        ...
        for(let i = 0; i < count; i++)
        {
            ...
            {
                await product.locator("//button[@class='btn btn-info']").click();
                break;
            }
        }
    }
